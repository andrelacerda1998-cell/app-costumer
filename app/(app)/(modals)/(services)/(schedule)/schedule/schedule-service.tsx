    ...
    <SafeAreaView className="flex-1 bg-primary">
      ...
      >
          <View className="flex-1 bg-support_secondary p-5 rounded-t-3xl gap-y-4" style={{ paddingBottom: 112 }}>
            ...
            {/* A escolha de repetir mudou-se para o checkout: aqui chegava
                cedo de mais. Quem está a resolver o *quando* ainda não viu o
                preço, e comprometer-se com uma série semanal é uma decisão de
                outra ordem — pertence ao lado do valor a pagar. */}
