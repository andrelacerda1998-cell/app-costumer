export default {
  ...
  "services": {
    ...
    "custom_request": {
        ...
        "address_label": "Where is the job?",
        "address_pick": "Choose an address",
        "phone_label": "Your contact",
        "phone_verify": "Verify phone number",
        "phone_verified": "{{phone}} confirmed",
        "phone_hint": "We confirm your number so we can tell you when quotes arrive.",
  ...
  "guest": {
    ...
    "cart": {
      ...
      "no_vendors_hint": "We could not find technicians for these services right now. You can search again or schedule for another time.",
...
"general": {
    ...
    "street_number_required": "Enter the door number. If there is none, write n/a.",
    "locality": "District",
