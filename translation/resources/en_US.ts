export default {
  ...
  "auth": {
    "home": {
      ...
      "benefits": {
        ...
        "secure_account": "Secure and protected account"
      }
    },
    "forgot_password": {
    ...
    "sign_in": {
      ...
      "login": "Sign In",
      "use_email_instead": "Sign in with email and password",
      "use_phone_instead": "Sign in with phone number"
    },
    "sign_up": {
      "header": "Registration",
      ...
      "skills_selection": {
        "title": "Let's add your skills",
        "subtitle": "Skills selection",
        "no_skills_found": "No skills found"
      },
      "documents": {
        "title": "Upload your files",
        "subtitle": "File should be PDF, JPG, PNG",
        "permission_required": "We need your permission to access your documents",
        "document": {
          "label": "Document",
          "upload": "Upload"
        },
      ...
      "price_rate": {
        "subtitle": "After analyzing your skills, we suggest that your price/hour be this",
  ...
  "session": {
    ...
    "sms": {
      ...
      "code": "Code",
      "code_required": "You must enter the code",
  ...
  "services": {
      ...
      "started_at": "Started",
      "confirm_completion": "Finish and rate",
    ...
    "schedule_service": {
      ...
      "tomorrow": "Tomorrow",
      "repeat_title": "Repeat",
      "repeat_subtitle": "Book once and we handle the next ones.",
      "repeat_once": "Once",
      "repeat_weekly": "Weekly",
      "repeat_biweekly": "Every two weeks",
      "repeat_monthly": "Monthly",
      "repeat_hint": "One at a time. We let you know before the next one so you can confirm — you only pay what you confirm.",
      ...
      "confirm": "Confirm",
      "no_slots_title": "No slots available",
    ...
    "select_vendor": {
      ...
      "retry": "Try again",
      "no_vendors_subtitle": "Technicians free up throughout the day. Try again or book a time that suits you.",
      "schedule_instead": "Schedule for another time",
      "searching_technicians": "Finding the right technician",
      "searching_technicians_hint": "Technicians will appear here for you to choose",
      "no_vendors_found": "No technicians free yet",
    ...
    "checkout": {
      ...
      "pending_occurrence_title": "Booking to confirm",
      "pending_occurrence_subtitle": "The slot is held for you, but only secured once you pay.",
      ...
      "cancel_policy_immediate": "Free cancellation until the technician sets off.",
      ...
      "resume": {
        ...
        "repeats_weekly": "Repeats every week",
        "repeats_biweekly": "Repeats every two weeks",
        "repeats_monthly": "Repeats every month",
        "repeats_hint": "You only pay this one. We let you know before the next one so you can confirm.",
      ...
      "three_ds": {
        "pending_title": "Did you authorize in your bank's app?",
        "pending_subtitle": "If you already approved the payment in your bank's app, tap verify — confirmation can take a few seconds.",
        "check_again": "I authorized, verify",
    ...
    "cancel": {
      ...
      "you_are_about_to_charged": "You are about to cancel a service that is already under way.",
      "charge_title": "You will be charged 100% of the service value",
      "charge_title_amount": "You will be charged {{amount}} — 100% of the value",
      "charge_explanation": "The technician has already travelled to you, so cancelling from this point on is charged in full.",
      "confirm_with_charge": "Cancel and pay {{amount}}",
      ...
      "notice_fees": "Last-minute cancellations may have associated costs.",
      "back": "Back",
      "loading": "Canceling..."
    },
    "close": {
    ...
    "custom_request": {
        ...
        "when_schedule": "Day and time",
        "when_pick": "Pick the day and time",
        "address_note": "At your main address.",
        "next_body": "We review the request and alert the right professionals. You get the proposals by notification and only pay after choosing.",
        "send": "Send request",
        "sending": "Sending…"
    },
    "list": {
    ...
    "service": {
      ...
      "open": {
        ...
        "map_unavailable_subtitle": "We do not have a location to show yet. It appears here as soon as we do.",
        "vendor_on_the_way": "Technician on the way",
      ...
      "service_state": "Service status",
        ...
        "arrived": "The professional has arrived at the location",
      },
      "pending": "Service waiting for professional to accept",
      "status": {
      ...
      "channel": {
        "accepted": {
          ...
          "subtitle": "The professional accepted the job"
        },
        "vendor_heading": {
          "title": "The professional is on the way",
          "subtitle": "You will be notified when the technician arrives at the address"
        },
        "canceled": {
          "title": "Service canceled",
      ...
      "vendor_arrived": {
        ...
        "subtitle": "The professional is ready to start the service",
        "continue": "Continue",
      }
    },
    ...
    "unavailable_card_title": "Your search hasn't been forgotten",
    "unavailable_card_subtitle": "We're evaluating new services. Soon, \"{{term}}\" may be part of our list.",
    "results_footer_card_title": "Missing a service?",
  ...
  "profile": {
    ...
    "my_profile": {
      ...
      "menu": {
        ...
        "history_sub": "Services you have already had",
  ...
  "matching": {
    "selection": {
      ...
      "hint_other": "Pick the one you prefer.",
      ...
      "none_subtitle": "No technician accepted. Try again or schedule for later.",
      "try_again": "Try again",
  ...
  "guest": {
    ...
    "addresses": {
      ...
      "search_empty_title": "Where is the service?",
      "search_empty_subtitle": "Type the address or use your location — we show you the technicians who work in that area.",
...
"general": {
    ...
    "address_required": "You must enter your address",
    "no_address": "No address",
    "login": "Sign in",
    ...
    "checking_zone": "Checking availability in your area...",
    "zone_not_available": "We don't have service available in your city yet.",
    "country": "Country",
    ...
    "location_unavailable": "Unable to determine your location. Please try again or enter manually.",
    "number": "Number",
    "street": "Street",
    "ios_picker": {
      "cancel": "Cancel",
    ...
    "phone_verification_required": "Confirm your phone number",
    "phone_verification_hint": "You can't request a service without it.",
    "email_verification_required": "You need to verify your email address",
    "blocked_by_zone": "Blocked by zone",
  },
  "geolocation": {
    "permission_title": "Turn on location",
    "permission_description": "To see the technicians near you.",
    "permission_button": "Turn on",
    "settings_dialog_title": "Turn on location in Settings",
    "settings_dialog_subtitle": "Location is turned off for Piquet. We'll open your phone Settings: tap \"Location\" and choose \"While using the app\". Then come back to Piquet.",
  ...
  "complete_profile": {
    ...
    "subtitle": "Fill in your details for a better experience.",
    "invoice_data": "You still haven't filled in your invoice data"
  },
  ...
  "schedules": "Schedules",
  "schedule_singular": "scheduled service",
  "schedule_plural": "scheduled services",
  "schedules_line_today": "{{count}} {{label}} for today",
  ...
  "schedules_awaiting_payment_other": "{{count}} to pay",
      "services_tab": {
        ...
        "requests_empty_subtitle": "Your requests show up here until you have a professional.",
        "request_ready_one": "1 professional available",
        ...
        "request_left_seconds_one": "1 s left",
        "request_left_seconds_other": "{{count}} s left",
        "request_expired": "Time is up",
  ...
  "consent_banner": {
    "message": "We use analytics tools to understand how you use this app and improve your experience. By tapping Accept, you agree to our Privacy Policy.",
    "accept": "Accept",
    "reject": "Reject",
  ...
  "schedules_screen": {
    ...
    "empty_title_today": "Nothing scheduled for today",
    ...
    "details": "See details",
      ...
      "recurrence_weekly": "Repeats every week",
      "recurrence_biweekly": "Repeats every two weeks",
      "recurrence_monthly": "Repeats every month",
